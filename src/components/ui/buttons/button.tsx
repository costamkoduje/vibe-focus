...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-m fonts-mono-m transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "h-12 px-6 py-3",
            sm: "h-10 rounded-m px-4 py-2 fonts-mono-xs",
    lg: "h-14 rounded-m px-8 py-4",
        icon: "h-12 w-12",
      },
    },
    defaultVariants: {
