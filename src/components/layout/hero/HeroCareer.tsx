...
export const HeroCareerSection = (): React.JSX.Element => {
  ...
  return (
    <section className="relative w-full flex flex-col md:px-5 px-0">
      {/* Text Section - 70vh */}
      <div className="relative w-full h-[60vh] sm:h-[80vh] lg:h-[88vh] flex items-center justify-center bg-gray-dark rounded-3xl sm:mt-4 px-5 sm:px-5">
      ...
      {/* Image Section - 90vh */}
      <div className="relative w-full h-[60vh] sm:h-[75vh] lg:h-[90vh] rounded-b-[20px] overflow-hidden sm:mb-5">
        <Image 
