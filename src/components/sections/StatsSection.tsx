...
export const StatsSection = (): React.JSX.Element => {
  const stats = [
    {
      ...
      value: "250+",
      description: "KOMPLETNYCH PROJEKTÓW"
    },
    {
      icon: (
        <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section className="flex flex-col w-full items-center py-20 relative bg-colors-gray-mid pb-80">
      <div className="w-full">
        ...
        <div className="grid-system">
          ...
          <div className="grid-col-8">
            <div className="bg-colors-gray-dark rounded-[34px] p-1">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                {stats.map((stat, index) => (
                  <div 
                    key={index} 
                    className="bg-colors-gray-mid flex flex-col gap-5 p-10 rounded-[32px]"
                  >
                    {/* Icon container */}
                    <div className="bg-colors-gray-dark rounded-[16px] w-[82px] h-[82px] flex items-center justify-center">
                      {stat.icon}
                    </div>
